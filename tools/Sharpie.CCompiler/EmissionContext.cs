...
{
    private readonly bool[] _tempInUse = new bool[
        SharpieEmitter.TempRegisterEnd - SharpieEmitter.TempRegisterStart + 1
    ];
    ...
    {
        Instructions.Add(Instruction.Parse(asm));
    }
    ...
    public TempLease AcquireTempRegister()
    {
        for (var i = 0; i < _tempInUse.Length; i++)
        {
            ...
            _tempInUse[i] = true;
            return new TempLease(this, SharpieEmitter.TempRegisterStart + i);
        }
    ...
    public List<int> GetActiveTempRegisters()
    {
        ...
        {
            if (_tempInUse[i])
                active.Add(SharpieEmitter.TempRegisterStart + i);
        }
        return active;
    }
