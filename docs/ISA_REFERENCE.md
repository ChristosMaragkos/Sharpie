...
| `0x55` | **SIGEX** | `R` | 2 | Sign-extend low byte of register R into high byte. |  |
...
| `0xC3` | **CRSPOS** | `R, R` | 2 | Set text cursor to (RX, RY). | Relative Move cursor by (RX, RY). |
...
| `0xC2` | **SAVE** | `R, R` | 2 | Saves R2 bytes starting from R1 to the save file. | Loads R2 bytes starting in R1 from the save file. |
