...
**Converting PNG images to sprite data:**
You may also use the CLI tool to convert a PNG image to Sharpie sprite data either for use with C or assembly:

```sh
sharpie image.png -o sprites/sprite_0.c # you can also pass in multiple PNG files
# or, for assembly:
#sharpie image.png -o sprites/sprite_0.asm
```
